...
//        // public functions
//        init: function () {
//            _wizardEl = KTUtil.getById('edit_good_wizard');
//            //_formEl = KTUtil.getById('edit-good-form');
...
$('#submit').on('click', function () {
    if (validation) {
        validation.validate().then(function (res) {
            if (res == 'Valid') {
                Edit();
            }
        })
...
function _initValidation() {
    // Init form validation rules. For more info check the FormValidation plugin's official documentation:https://formvalidation.io/
    // Step 1
    var form = document.getElementById('edit-good-form')
